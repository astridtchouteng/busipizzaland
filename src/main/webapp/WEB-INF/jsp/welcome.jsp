                        ...
                        <c:forEach items="${cats}" var="cat">
                            <a class="list-group-item d-flex justify-content-between align-items-center
                               ...
                               data-toggle="list" href="#" role="tab" aria-controls="profile">
                                    ${cat} <span class="badge badge-primary badge-pill">2</span>
                            </a>
                        </c:forEach>
                    </div>
                </div>
                    ...
                    <c:if test="${pizzas!= null  and  not empty pizzas}">
                        <div class="row card-deck">
                            <c:forEach items="${pizzas}" var="pizza">
                                <div class="card text-white bg-warning mb-3 mr-3"  style="max-width: 400px; max-height: 400px;">
                                    <div class="card-header">${pizza.categorie}</div>
                                    <div class="card-body">
                                        <h5 class="card-title">Description</h5>
                                        <div class="card-text"><p>${pizza.description}</p></div>
                                        <div class="row">
                                            <div class="col-xs-12 col-md-12 col-lg-12">
                                                <form class="form-row my-2 my-lg-0">
                                                    <div class="col-4">
                                                        <input class="form-control mr-sm-2" type="number" min="1" max="20" value="1"/>
                                                    </div>
