...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <form:form method="post" action="${pageContext.request.contextPath}/enregistrer" modelAttribute="pizza">
                <div class="form-group">
                    <form:label path="categorie"><label>Categorie</label></form:label>
                    <form:input path="categorie" cssClass="form-control"></form:input>
                </div>
                <div class="form-group">
